			...
			<div class="card-block">
				...
				<?php $no++;?>
					<tbody>
							...
							<td>{{$datas->nama}}</td>
							<td>{{$datas->sks}}</td>
							<td><a href="{{url('datamatkul/'.$datas->id.'/edit')}}" class="btn btn-success btn-sm">Edit</a>&nbsp;<a href="{{url('datamatkul/'.$datas->id.'/delete')}}" class="btn btn-danger btn-sm" onclick="return confirm('Hapus {{$datas->namaMatkul}}?')">Hapus</a></td>
